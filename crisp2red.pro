; docformat = 'rst'
;+
; Class crisp2red and subroutines, class polarim and subroutines.
; 
; Reduction pipeline for the SST. Steps prior to momfbd. 
;
; :Categories:
;
;    CRISP pipeline
...
; 
;-
function crisp2red, filename, develop = develop, no_db = no_db

  return, obj_new('crisp2', filename, develop = develop, no_db = no_db)
