function red_solarsoft_get_sun, isodate, et=et, lon=lon, $
...
;       OUT = GET_SUN(ITEM)
; INPUTS:
;       ISODATE - Reference time for ephemeris data.  Interpreted as
...
;	  difference is noticable slightly.  Should be given in ISO
;	  form, yyyy-mm-dd.
; KEYWORD INPUTS:
...
;       8-Oct-1998 - S.L.Freeland - allow any SSW time (via anytim
;                    front end)
;       2021-12-15 - MGL. Adapt for use in SSTRED, without any other
...
;    print,' Solar Ephemeris for ' + fmt_tim(itemx)    
    print,' Solar Ephemeris for ' + isodate
    print,' '
