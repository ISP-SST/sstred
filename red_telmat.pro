...
function red_telmat, lam, telpos, time $
  ...
  if(year lt 2015) then begin
    ...
    endcase
  endif else if(year lt 2024) then begin
    ...
    print, "red_telmat: Using latest telescope parameters, year -> ", year
    case lam_s of
      '5173': begin
        par = [0.996293, 0.00133456, -0.00883209, 1.00000, -0.0122859, $
               0.940534, 23.9875, 0.999177, 0.322424, 1.00000, 0.00000, $
               33.0000, 0.0170039, -37.0000, 48.5000]
      end
      '5250': begin
        print, "red_telmat: No update, use old values"
        par = [0.98895,  0.00284, -0.06396,  1.00000,  0.01845,  $
               0.93627, 20.64541,  1.00000, -0.16907,  1.00000,  0.00000, $
               45.00000,  0.01453, -36.12000, 50.60000]
      end
      '5876': begin
        par = [0.998272, 0.00141089, -0.0115499, 1.00000, -0.00731505, $
               0.935451, 20.7633, 1.00000, 0.399388, 1.00000, 0.00000, $
               33.0000, 0.00746284, -37.0000, 48.5000]
      end
      '5896': begin
        print, "red_telmat: No update, use old values"
        par = [0.97120,  0.00149, -0.05806,  0.97786,  0.01582,  $
      ...
      '6173': begin
        par = [0.990728, -0.000729998, -0.0378590, 0.997346, 0.0374415, $
               0.933249, 17.6415, 1.00000, 0.415135, 1.00000, 0.00000, $
               33.0000, 0.00684711, -37.0000, 48.5000]
      end
      '6300': begin
        ;; Use parameters for 6302.
        par = [0.992471, 0.00173724, -0.0106124, 0.993985, -0.00667955, $
               0.931540, 19.3743, 1.00000, 0.361103, 1.00000, 0.00000, $
               33.0000, 0.00228383, -37.0000, 48.5000]
      end
      '6302': begin
        par = [0.992471, 0.00173724, -0.0106124, 0.993985, -0.00667955, $
               0.931540, 19.3743, 1.00000, 0.361103, 1.00000, 0.00000, $
      ...
      '6563': begin
        par = [0.986540, 0.000259803, -0.0355558, 0.992075, 0.0332960, $
               0.929466, 16.6210, 1.00000, 0.632170, 1.00000, 0.00000, $
               33.0000, 0.00423246, -37.0000, 48.5000]
      end
      '7699': begin
        par = [0.995976, 0.00175738, -0.0182085, 0.994994, 0.00613438, $
               0.907194, 15.4404, 0.999450, 0.342232, 1.00000, 0.00000, $
               33.0000, 0.00166983, -37.0000, 48.5000]
      end
      '7772': begin
        print, "red_telmat: No update, use old values"
        par = [0.99835,  0.00060, -0.00081,  0.99997, -0.01294,  $
      ...
      '8542': begin
        par = [0.990040, -0.000295390, -0.0287213, 0.996326, 0.0355930, $
               0.897265, 13.8994, 1.00000, 0.303810, 1.00000, 0.00000, $
               33.0000, 0.00243412, -37.0000, 48.5000]
      end
      else: begin
        message, 'No information for wavelength '+lam, /continue
        return, diag_matrix([1.,1.,1.,1.])
