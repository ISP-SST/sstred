...
ENDCASE
 ...
 ;;; polcal-corrected Q direction and the north direction.  The way I do the
 ;;; fit (use QWP as reference) gives ~10.7 degrees, but for data done with a
 ;;; normal polcal one should set it to zero...
