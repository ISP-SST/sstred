...
;
;   2016-09-01 : JLF. Added head keyword to bypass an infinite loop;
;                red_detectorname and red_readhead were calling each
;                other.
; 
;-
function red_detectorname, file, head=head

  ;; If we've been passed a header already don't try to use
  ;; red_readhead. This bypasses an infinite loop!
