...
typedef struct _idl_tagdef  {
    /* Definition of each instance of a tag
    				   in a structure: */
    IDL_IDENT *id;
...
typedef struct {
    /* Graphic text attribute structure.
 ...
 */
typedef struct {
    /* Device descriptor, mostly static attributes
    				   and definitions: */
