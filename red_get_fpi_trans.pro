...
;+
;  Outputs the transmission profile of CRISP accounting for the
;  converging beam.
; 
; :Categories:
;
...
; :author:
; 
;   Göran Scharmer (Original dual_fpi2.ana, 2008)
;
;   Jaime de la Cruz Rodriguez, ISP-KVA. (Ported to IDL, 2010.)
; 
; 
; :returns:
; 
;    It returns a structure with the nominal reflectivities and cavity
...
;               Improved quadrature for the integration with only
;               three points.
;
...
; 
;-
function red_get_fpi_trans, fpi, lam, ech = ech, ecl = ecl, erh = erh, erl = erl
