...
;
;      Select image to display in xroi GUI by setting ituning, istokes,
;      and/or iscan. Indices not specified signals a dimension to sum
;      over. 
;
;    istokes : in, optional, type=integer
;
;      Select image to display in xroi GUI by setting ituning,
;      istokes, and/or iscan. Indices not specified signals a
...
pro red::fitscube_crop, infile $
  ...
  if n_elements(roi) ne 4 then begin
